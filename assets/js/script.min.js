...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const partnerDetails = {
    Google: {
      ...
      url: 'https://www.google.com/ads/publisher/partners/'
    },
    AppLovin: {
      title: 'AppLovin',
    ...
    Pangle: {
      ...
      url: 'https://www.pangle.com/'
    },
    InMobi: {
      title: 'InMobi',
      description: 'InMobi 파트너십 상세 소개글 (내용을 채워주세요)',
      url: '#'
    },
    DigitalTurbine: {
      title: 'Digital Turbine',
      description: 'Digital Turbine 파트너십 상세 소개글 (내용을 채워주세요)',
      url: '#'
    },
    TheTradeDesk: {
      title: 'The Trade Desk',
      description: 'The Trade Desk 파트너십 상세 소개글 (내용을 채워주세요)',
      url: '#'
    },
    RTBHouse: {
      title: 'RTB House',
      description: 'RTB House 파트너십 상세 소개글 (내용을 채워주세요)',
      url: '#'
    },
    PubMatic: {
      title: 'PubMatic',
      description: 'PubMatic 파트너십 상세 소개글 (내용을 채워주세요)',
      url: '#'
    },
    Fluct: {
      title: 'Fluct',
      description: 'Fluct 파트너십 상세 소개글 (내용을 채워주세요)',
      url: '#'
    },
    OpenX: {
      title: 'OpenX',
      description: 'OpenX 파트너십 상세 소개글 (내용을 채워주세요)',
      url: '#'
    }
  };
